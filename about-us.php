...
<main class="main__content_wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        <span class="about__content--subtitle text__secondary mb-20"> Welcome To The Online Clothing Store</span>
                        <h2 class="about__content--maintitle mb-25">Passion for Fashion, Quality and Style</h2>
                        <p class="about__content--desc mb-20">Fueled by a sincere passion for fashion, quality commitment, and an appreciation for timeless style, our brand aspires to curate an experience for those who cherish self-expression through fashion. Each stitch, fabric, and design element is meticulously chosen to embody a profound statement of personal style beyond mere garments.</p>
                        <p class="about__content--desc mb-25">Our relentless pursuit of quality distinguishes us in the dynamic fashion landscape, where true style is defined not only by what you wear but how you wear it. From sourcing premium materials to ensuring durability and comfort, each piece in our collection reflects our commitment to the highest standards, inviting you to immerse yourself in the embodiment of our passion for fashion and enduring style.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="brand__logo--section section--padding" style="background-color: #dbdbdb">
        <div class="section__heading text-center mb-50">
            <h2 class="section__heading--maintitle style2">Our Partners</h2>
        </div>
    ...
    <section class="team__section section--padding">
        <div class="container">
            <div class="section__heading text-center mb-50">
                <h2 class="section__heading--maintitle style2">Company Leadership</h2>
            </div>
