        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                ...
                <div class="contact__form">
                    ...
                    <form class="contact__form--inner" method="post" action="./final_email/email/mail.php">
                        <div class="row">
                        ...
                        <button class="contact__form--btn primary__btn" type="submit" name="send">Send A Message</button>  
                    </form>
                </div>
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white mt-3"><a href="tel:+01234-567890">+01234-567890</a> <a href="tel:++01234-5688765">+01234-5688765</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="mailto:info@gmail.com">info@gmail.com</a> <br> <a href="mailto:support@gmail.com">support@gmail.com</a></p> 
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white mt-3">  House no 1 ,
                                    Street no 1,
                                    Country.</p> 
                            </div>
                        </div>
