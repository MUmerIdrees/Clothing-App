                                    ...
                                    <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                ...
                                                <div class="product__items--content">
                                                    <h3 class="product__items--content__title h4"><a href="shop-details.php">Oversize Cotton Dress</a></h3>
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items ">
                                                ...
                                                <div class="product__items--content">
                                                    <h3 class="product__items--content__title h4"><a href="shop-details.php">Boxy Denim Jacket</a></h3>
                                                    <div class="product__items--price">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="shop-details.php">Quilted Shoulder Bag</a></h4>
                                                    <div class="product__items--price">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="shop-details.php">Square Shoulder Bag</a></h4>
                                                    <div class="product__items--price">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="shop-details.php">Western denim shirt</a></h4>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$115</span>
                                                    </div>
                                                    <ul class="product__items--action d-flex">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="shop-details.php">High Ankle Jeans</a></h4>
                                                    <div class="product__items--price">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="shop-details.php">OSmock Mini Dresss</a></h4>
                                                    <div class="product__items--price">
                                                        <span class="current__price">$110</span>
                                                    </div>
                                                    <ul class="product__items--action d-flex">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items">
                                                ...
                                                <div class="product__items--content">
                                                    <h4 class="product__items--content__title"><a href="show-details.php">Quilted Shoulder Bag</a></h4>
                                                    <div class="product__items--price">
                                    ...
                                    <div class="row row-cols-1 mb--n30">
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="shop-details.php">Oversize Cotton Dress</a></h3>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$110</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Step into laid-back luxury with our Oversize Cotton Dress. Embrace comfort without compromising style in this loose-fitting silhouette, crafted from high-quality cotton for a soft and breathable feel. The versatile design makes it perfect for any occasion, whether you're lounging at home or strolling through the city. With its relaxed vibe and modern flair, this dress effortlessly combines fashion and comfort, making it a must-have for your wardrobe. Upgrade your casual ensemble with the easy elegance of our Oversize Cotton Dress.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="shop-details.php">Boxy Denim Jacket</a></h3>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$120</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Revitalize your wardrobe with our Boxy Denim Jacket, a contemporary twist on a classic staple. The relaxed, boxy fit adds a modern edge to the timeless denim style, making it a versatile piece for any season. Crafted from premium denim, the jacket offers durability and comfort, while its casual silhouette effortlessly complements various outfits. Whether paired with dresses or jeans, this jacket is a fashion-forward choice for a laid-back yet chic look. Elevate your outerwear collection with the trendsetting appeal of our Boxy Denim Jacket.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="shop-details.php">Quilted Shoulder Bag</a></h3>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$115</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Introducing our Quilted Shoulder Bag – a perfect blend of sophistication and functionality. The meticulously quilted pattern adds a touch of elegance to this accessory, making it a versatile companion for both casual and formal occasions. Crafted with attention to detail, the bag features a spacious interior to accommodate your essentials, while the adjustable shoulder strap ensures comfort on the go. Elevate your style with the timeless charm of this quilted bag, designed to seamlessly complement your wardrobe and make a chic statement wherever you carry it. Indulge in fashion-forward luxury with our Quilted Shoulder Bag.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="shop-details.php">Square Shoulder Bag</a></h3>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$114</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Discover modern elegance with our Square Shoulder Bag, a sleek and structured accessory that effortlessly combines fashion and functionality. The clean lines and minimalist design make it a versatile companion for any ensemble, from day to night. The square shape adds a contemporary edge, while the spacious interior provides ample room for your essentials. With an adjustable shoulder strap for convenience, this bag is a chic and practical choice for the fashion-forward individual. Elevate your style with the understated sophistication of our Square Shoulder Bag.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h3 class="product__list--items__content--title h4 mb-10"><a href="shop-details.php">Light Denim Jackets</a></h3>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$122</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Introducing our Light Denim Jacket – the perfect layering piece for a touch of casual cool. Crafted from soft and breathable denim, this jacket adds a laid-back vibe to any outfit. The light wash enhances its versatility, making it an ideal companion for spring and summer. With a classic silhouette and button-front closure, this jacket effortlessly elevates your everyday style. Embrace the relaxed charm of our Light Denim Jacket for an easygoing yet on-trend look.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items d-flex">
                                                ...
                                                <div class="product__list--items__content">
                                                    <h4 class="product__list--items__content--title mb-10"><a href="shop-details.php">OSmock Mini Dresss</a></h4>
                                                    <div class="product__list--items__price mb-10">
                                                        <span class="current__price">$125</span>
                                                    </div>
                                                    <p class="product__list--items__content--desc d-none d-xl-block mb-15">Unleash your playful side with our Osmock Mini Dress, a chic and flirty addition to your wardrobe. The dress features a trendy oversized smock style that exudes contemporary charm. Crafted from high-quality fabric, it ensures both comfort and a flattering fit. The mini length adds a touch of flirtiness, making it perfect for a night out or a fun day in the sun. Embrace effortless style with the Osmock Mini Dress, where fashion meets comfort in a delightful fusion.</p>
                                                    <ul class="product__items--action d-flex">
                                                        <li class="product__items--action__list">
                                                            <a class="product__items--action__btn add__to--cart" href="cart.php">
                                                                <svg class="product__items--action__btn--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="20.443" viewBox="0 0 14.706 13.534">
                            ...
                            <nav class="pagination justify-content-center">
                                <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                    <li class="pagination__list">
                                        <a href="shop.php" class="pagination__item--arrow  link ">
